...
const LargeCard = ({ cardData, size }: { cardData: any, size: 'small' | 'medium' | 'big' | 'large' }) => {
    const sizeConfigs = {
        ...
        big: {
            container: "h-99 w-72.5 rounded-[36px]",
            padding: "px-7 pt-7 mb-5",
            iconSize: 14,
            categoryText: "text-sm",
            illusContainer: "h-81 bottom-1.8",
            kanbanImg: "h-76.5 bottom-10.8 w-full left-1/2 -translate-x-1/2",
