...
const FilterSection = ({activeFilter, activeNd, activeCard, setActiveFilterTagClicked, setActiveNdTagClicked, setActiveCardButton}: 
    { activeFilter: null | string, activeNd: null | string, activeCard: null | string, setActiveFilterTagClicked: (val: string | null) => void, setActiveNdTagClicked: (val: string | null) => void, setActiveCardButton: (val: string | null) => void}) => {
   return (
